...
import NicopernasChatNicopernasChatChat from './nicopernas/chat/nicopernas.chat.chat'
...
export default { 
  ...
  NicopernasChatNicopernasChatChat: load(NicopernasChatNicopernasChatChat, 'nicopernas.chat.chat'),
