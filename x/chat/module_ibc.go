...
func (am AppModule) OnRecvPacket(
	...
	case *types.ChatPacketData_NewSpaceMessagePacket:
		packetAck, err := am.keeper.OnRecvNewSpaceMessagePacket(ctx, modulePacket, *packet.NewSpaceMessagePacket)
		if err != nil {
		...
		ctx.EventManager().EmitEvent(
			sdk.NewEvent(
				types.EventTypeNewSpaceMessagePacket,
...
func (am AppModule) OnAcknowledgementPacket(
	...
	switch packet := modulePacketData.Packet.(type) {
	case *types.ChatPacketData_NewSpaceMessagePacket:
		err := am.keeper.OnAcknowledgementNewSpaceMessagePacket(ctx, modulePacket, *packet.NewSpaceMessagePacket, ack)
		if err != nil {
			return err
		}
		eventType = types.EventTypeNewSpaceMessagePacket
...
func (am AppModule) OnTimeoutPacket(
	...
	switch packet := modulePacketData.Packet.(type) {
	case *types.ChatPacketData_NewSpaceMessagePacket:
		err := am.keeper.OnTimeoutNewSpaceMessagePacket(ctx, modulePacket, *packet.NewSpaceMessagePacket)
		if err != nil {
			return err
		}
